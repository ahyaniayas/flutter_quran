class Detail {
  ...
  bool? status;
  List<Ayat>? ayat;
  SuratNav? suratSelanjutnya;
  SuratNav? suratSebelumnya;
  ...
  Detail.fromJson(Map<String, dynamic> json) {
    ...
    suratSelanjutnya = (json['surat_selanjutnya'] != false &&
        ...
        ? SuratNav?.fromJson(json['surat_selanjutnya'])
        : null;
    suratSebelumnya =
        (json['surat_sebelumnya'] != false && json['surat_sebelumnya'] != null)
            ? SuratNav?.fromJson(json['surat_sebelumnya'])
            : null;
  }
...
class SuratNav {
  ...
  SuratNav.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    nomor = json['nomor'];
    nama = json['nama'];
    namaLatin = json['nama_latin'];
